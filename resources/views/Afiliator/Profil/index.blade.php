...
<div class="main-content">
    <section class="section">
      ...
      <div class="col-12 mb-4">
        <div class="hero hero-bg-image text-white" style="background-image: url('assets/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg');">
          <div class="hero-inner">
            ...
            <div class="author-box-description">
              <div class="row">
                  ...
                  <div class="col-md-3">NIP</div><div class="col-md-9"> : {{ auth()->user()->nip }}</div>

              </div>
            </div>
            <div class="mt-4">
              <a href="{{ route('profil.edit', auth()->user()->id) }}" class="btn btn-outline-white btn-lg btn-icon icon-left"><i class="far fa-user"></i> Edit Account</a>
            </div>
          </div>
        </div>
      </div>
