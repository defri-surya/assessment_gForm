                        ...
                        @endif --}}
                                        ...
                                        <div class="card-body">
                                            <form action="{{ route('siswa.store') }}" method="POST">
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label
                                                        class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Psikolog</label>
                                                    <div class="col-sm-12 col-md-7">
                                                        <select name="afiliator" id="" class="form-control"
                                                            required>
                                                            <option value="">Pilih Psikolog</option>
                                                            @forelse ($afiliator as $item)
                                                                <option
                                                                    {{ old('afiliator') == $item->id ? 'selected' : '' }}
