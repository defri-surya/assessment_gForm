            ...
            <div class="row mb-1" style="padding: 12px; background-color: white; ">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-md-8">: <span style="color: blue; font-weight: bold">{{ $hasilsemua->nama }}</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">Jenis Kelamin</div>
                        <div class="col-md-8">: {{ $hasilsemua->jeniskelamin }}</div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">Tanggal Lahir</div>
                        <div class="col-md-8">: {{ Carbon\Carbon::parse($hasilsemua->tanggallahir)->isoFormat('D MMMM Y') }}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-md-8">: {{ $hasilsemua->created_at }}</div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">Asal Sekolah</div>
                        <div class="col-md-8">: {{ $hasilsemua->namasekolah }}</div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">NISN</div>
                        <div class="col-md-8">: {{ $hasilsemua->nisn }}</div>
                    </div>
                </div>
                {{-- </div>     --}}
            </div>
                ...
                <div class="col-lg-4 col-md-12 col-12 col-sm-12">
                    ...
                    <a href="#" class="btn">Month</a> --}}
                        ...
                        <div class="card-body">
                            ...
                            <canvas id="myChart" height="320" width="530" class="chartjs-render-monitor"
                                style="display: block; width: 265px; height: 160px;"></canvas>
                ...
                <div class="col-lg-4 col-md-12 col-12 col-sm-12">
                    ...
                    <a href="#" class="btn">Month</a> --}}
                        ...
                        <div class="card-body">
                            ...
                            <canvas id="myChartLest" height="320" width="530" class="chartjs-render-monitor"
                                style="display: block; width: 265px; height: 160px;"></canvas>
                            <div class="statistic-details mt-sm-4">
                                <div class="statistic-details-item">
                ...
                <div class="col-lg-4 col-md-12 col-12 col-sm-12">
                    ...
                    <a href="#" class="btn">Month</a> --}}
                        ...
                        <div class="card-body">
                            ...
                            <canvas id="myChartDif" height="320" width="530" class="chartjs-render-monitor"
                                style="display: block; width: 265px; height: 160px;"></canvas>
                            <div class="statistic-details mt-sm-4">
                                <div class="statistic-details-item">
...
@section('js')
    ...
    <script>
        ...
        var xxx = <?php echo $hasilsemua->id; ?>;
        $(document).ready(function() {
            $("#print").click(function() {
                ...
                window.print();
                window.location.replace("/hasilsemua/" + xxx);
            });
        });
    </script>
@endsection
