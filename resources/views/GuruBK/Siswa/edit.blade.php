                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-sm-12 col-md-7">
                                                        <select name="jeniskelamin" id="" class="form-control">
                                                            ...
                                                            <option
                                                                {{ $siswa->jeniskelamin == 'Laki-Laki' ? 'selected' : '' }}
                                                                value="Laki-Laki">Laki-Laki</option>
                                                            <option
                                                                {{ $siswa->jeniskelamin == 'Perempuan' ? 'selected' : '' }}
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-sm-12 col-md-7">
                                                        <input type="date" name="tanggallahir" class="form-control"
                                                            placeholder="Tanggal Lahir" value="{{ $siswa->tanggallahir }}">
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-sm-12 col-md-7">
                                                        <input type="text" name="nisn" class="form-control"
                                                            placeholder="NISN Siswa" value="{{ $siswa->nisn }}">
                                                        @if ($errors->has('nisn'))
                                                            <small id="emailHelp"
