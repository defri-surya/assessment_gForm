                ...
                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="col-md-8">
                                <a class="btn btn-primary" href="{{ route('afiliator.create') }}">Tambah Data</a>
                            </div>
                            <div class="col-md-4">
                                <form method="GET" action="{{ route('afiliator.index') }}">
                                                ...
                                                <tbody>
                                                    ...
                                                    @forelse ($data as $item => $user)
                                                        ...
                                                        @endempty --}}
                                                            ...
                                                            <td>
                                                                <form method="POST"
                                                                    action="{{ route('afiliator.destroy', $user) }}"
                                                                    onsubmit="return confirm('Hapus Data, Anda Yakin ?')">
                                                                    @method('DELETE')
                                                                    @csrf
                                                                    <a class="btn btn-icon btn-primary"
                                                                        href="{{ route('afiliator.edit', $user) }}"><i
