                ...
                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            {{-- <div class="col-md-8">
                                <a class="btn btn-primary" href="{{ route('gurubk.create') }}">Tambah Data</a>
                            </div> --}}
                            <div class="col-md-12">
                                <form method="GET" action="{{ route('gurubk.index') }}">
                                            ...
                                            <table class="table table-striped table-md">
                                                <tbody>
                                                    ...
                                                    @forelse ($data as $item => $user)
                                                        ...
                                                        {{-- <td>
                                                            <form method="POST"
                                                                action="{{ route('gurubk.destroy', $user) }}"
                                                                onsubmit="return confirm('Hapus Data, Anda Yakin ?')">
                                                                @method('DELETE')
                                                                @csrf
                                                                <a class="btn btn-icon btn-primary"
                                                                    href="{{ route('gurubk.edit', $user) }}"><i
