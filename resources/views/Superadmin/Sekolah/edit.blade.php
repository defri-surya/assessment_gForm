                        ...
                        <div class="card-body">
                            <form action="{{ route('sekolah.update', $sekolah) }}" method="POST">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <input type="text" name="namasekolah" value="{{ $sekolah->namasekolah }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                    <textarea name="alamat" class="form-control" cols="30" rows="10">{{ $sekolah->alamat }}</textarea>
                                    </div>
                                </div>
