                ...
                <div class="row">
                    <div class="col-12">
                      <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('setsoal.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <select name="sekolahid" id="" class="form-control">
                                        ...
                                        @forelse ($sekolah as $item)
                                            <option {{ old('sekolahid') == $item->id ? "selected" : "" }} value="{{ $item->id }}">{{ $item->namasekolah }}</option>
                                        @empty
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <select name="kategorisoalid" id="" class="form-control">
                                        ...
                                        @forelse ($kategori as $item)
                                            <option {{ old('kategorisoalid') == $item->id ? "selected" : "" }} value="{{ $item->id }}">{{ $item->namakategori }}</option>
                                        @empty
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <select name="status" id="" class="form-control">
                                        <option value="" selected>Pilih Status</option>
                                            ...
                                            <option {{ old('status') == 'pasif' ? "selected" : "" }} value="pasif">Pasif</option>
                                    </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                    <input type="date" name="tanggalmulai" class="form-control" placeholder="Tanggal Mulai Aktif" value="{{ old('tanggalmulai') }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                    <input type="date" name="tanggalselesai" class="form-control" placeholder="Tanggal Akhir Selesai" value="{{ old('tanggalselesai') }}">
                                    </div>
                                </div>
